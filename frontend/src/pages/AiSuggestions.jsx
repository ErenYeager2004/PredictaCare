...
const makeComponents = () => ({
  ...
  ol: ({ children }) => (
    <ol style={{ margin: "0 0 16px", paddingLeft: 20 }}>{children}</ol>
  ),
  li: ({ children }) => (
    <li
      style={{
...
const AISuggestions = () => {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      ...
      try {
        const res = await fetch(`${BACKEND_URL}/api/ai-suggestions`, {
          method: "POST",
          headers: {
    ...
    >
      ...
      >
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", position: "relative" }}>
          ...
          <p
            style={{ fontSize: 15, color: "rgba(255,255,255,0.75)", margin: 0 }}
          >
      ...
      >
        {loading ? (
          ...
          <div style={{ animation: "fadeUp 0.5s ease" }}>
            ...
            >
              ⚕️ These suggestions are for informational purposes only and do
