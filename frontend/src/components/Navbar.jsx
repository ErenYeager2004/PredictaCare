              ...
              <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20">
                <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                  ...
                  <p
                    ...
                    className="hover:text-black cursor-pointer flex items-center gap-2 font-semibold"
                  >
                    DIAGNOAI
                    <span className="text-[8px] uppercase tracking-wide font-medium px-1.5 py-0.5 rounded bg-gradient-to-r from-[#FF8C00] to-[#FF3E3E] text-white shadow-md">
                      New
                    </span>
                  </p>
                  <p
